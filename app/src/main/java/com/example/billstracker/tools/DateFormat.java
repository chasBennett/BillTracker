...
public interface DateFormat {
    ...
    static long incrementDate(int frequency, long date) {
        return switch (frequency) {
            case 0 -> DateFormat.makeLong(DateFormat.makeLocalDate(date).plusDays(1));
            case 1 -> DateFormat.makeLong(DateFormat.makeLocalDate(date).plusWeeks(1));
            case 2 -> DateFormat.makeLong(DateFormat.makeLocalDate(date).plusWeeks(2));
            case 3 -> DateFormat.makeLong(DateFormat.makeLocalDate(date).plusMonths(1));
            case 4 -> DateFormat.makeLong(DateFormat.makeLocalDate(date).plusMonths(2));
            case 5 -> DateFormat.makeLong(DateFormat.makeLocalDate(date).plusMonths(3));
            case 6 -> DateFormat.makeLong(DateFormat.makeLocalDate(date).plusYears(1));
            default -> date;
        };
    }
