...
public class Bill {
    ...
    public Bill(String billerName, String amountDue, int dayDue, int dateLastPaid, String billsId, boolean recurring, String frequency, String website, String category, String icon, String paymentsRemaining,
                 double balance, double escrow) {
