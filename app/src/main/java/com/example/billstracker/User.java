...
public class User implements Serializable {
    ...
    public User(String userName, String password, String name, boolean admin,
                 String lastLogin, String dateRegistered, String id, ArrayList<Bill> bills, int totalLogins, String ticketNumber, double income, String payFrequency,
                 boolean termsAccepted, String termsAcceptedOn, ArrayList <Trophy> trophies, ArrayList <Budgets> budgets) {
